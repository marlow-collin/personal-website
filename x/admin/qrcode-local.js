/*
 Local QR generator bundle.
 QR encoder code: QRCode for JavaScript by Kazuhiko Arase (MIT).
 Bundled from qrcode-terminal's vendored QRCode implementation.
...
module.exports = QRCode;
  ...
  const QRCode = req("index");
  const ECL = req("QRErrorCorrectLevel");
