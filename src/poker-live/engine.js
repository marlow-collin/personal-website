...
export function publicState(s){ ensureBlindPositions(s); const {controllerToken,...safe}=s; return {...safe,currentBlinds:s.blindLevels[Math.min(s.level-1,s.blindLevels.length-1)],nextBlinds:s.blindLevels[s.level]||null}; }
